...
const selectTriggerStyle = tva({
  base: "border border-background-100 flex-row items-center overflow-hidden data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:data-[hover=true]:border-background-100 h-14",
  variants: {
    size: {
      xl: "h-12",
      lg: "h-11",
    ...
    variant: {
      ...
      outline:
        "rounded-2xl data-[focus=true]:border-primary-700 data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[focus=true]:data-[hover=true]:web:shadow-primary-600 data-[invalid=true]:web:shadow-[inset_0_0_0_1px] data-[invalid=true]:border-error-700 data-[invalid=true]:web:shadow-error-700 data-[invalid=true]:data-[hover=true]:border-error-700",
      rounded:
...
const selectInputStyle = tva({
  base: "p-4 placeholder:text-typography-500 web:w-full h-full text-typography-900 pointer-events-none web:outline-none ios:leading-[0px]",
  parentVariants: {
    size: {
      xl: "text-xl",
      lg: "text-lg",
...
const SelectTrigger = React.forwardRef<
  ...
  ISelectTriggerProps
>(({ className, size = "xl", variant = "outline", ...props }, ref) => {
  return (
    <UISelect.Trigger
